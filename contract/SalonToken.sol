...
contract TokenBase is IERC20 {
    ...
    function increaseAllowance(address spender, uint256 addedValue) public onlyPayloadSize(2 * 32)
    returns (bool) {
        require(spender != address(0));
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public onlyPayloadSize(2 * 32)
    returns (bool) {
        require(spender != address(0));
...
contract SalonToken is TokenBase, Administrative {
    constructor(string name, string symbol, uint8 decimals)
    TokenBase(name, symbol, decimals) {
